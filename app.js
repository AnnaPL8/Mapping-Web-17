...
const API_KEY = "pk.eyJ1IjoiYXNtODg4OCIsImEiOiJjanZlamR4YXYya25vNDNtZWN6N3pxcnZkIn0.SfY7mg3YJhwSITrRkoySFw";
...
//In order to get information from url I use method from d3 library which is defined as object in a given example. 
//Then I passed data from url to the function as data argument.
...
d3.json(URL, function(data){
    L.geoJSON(data.features, {
        ...
        //the "data" below refers to each event (earthquake/dictionary) in features(list)
        style: function(data){
            return {
        ...
        onEachFeature: function(feature, layer){
            ...
            new Date(feature.properties.time) + '</p>' + '<p>' + feature.properties.url + '</p>');
        }
